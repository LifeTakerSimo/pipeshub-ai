...
const StyledSignOutButton = styled(Button, {
  ...
  return {
    position: 'relative',
    height: 48,
    color: isDark ? alpha(theme.palette.error.main, 0.9) : theme.palette.error.main,
...
const IconContainer = styled(Box, {
  ...
  return {
    ...
    color: isDark ? alpha(theme.palette.error.main, isDark ? 0.9 : 1) : theme.palette.error.main,
  };
});
  ...
  return (
    ...
    >
      ...
      >
        ...
        <AnimatedText isHovered={isHovered}>Sign Out</AnimatedText>
      </Box>
    </StyledSignOutButton>
  );
}
