  ...
  return (
    ...
    >
      ...
      <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, mb: 2.5 }}>
        ...
        >
          <Iconify icon={cloudIcon} width={20} height={20} color={theme.palette.primary.main} />
        </Box>
      ...
      <Typography variant="body2" color="text.secondary" sx={{ mb: 3, fontSize: '0.8125rem' }}>
        Configure your Azure AD application credentials to connect to SharePoint Online. Upload your
        certificate and private key files for secure authentication.
      </Typography>
      ...
      <Box sx={{ mb: 2 }}>
        ...
        <Typography variant="body2" color="text.secondary" sx={{ mb: 2.5, fontSize: '0.8125rem' }}>
          Upload your X.509 certificate (.crt) and private key (.key) files for secure
          authentication.
        </Typography>
        ...
        <Box sx={{ mt: 2 }}>
          ...
          >
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
              <Iconify icon={checkIcon} width={20} height={20} color={theme.palette.success.main} />
              <Typography variant="caption" color="text.secondary">
