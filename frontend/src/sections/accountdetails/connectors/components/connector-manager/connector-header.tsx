...
import { Box, Chip, Stack, alpha, Button, useTheme, Typography, IconButton } from '@mui/material';
...
const ConnectorHeader: React.FC<ConnectorHeaderProps> = ({ connector, loading, onRefresh }) => {
    ...
    >
      <Stack spacing={2}>
        <Stack direction="row" alignItems="center" spacing={1.5}>
          ...
          >
            <img src={connector.iconPath} alt={connector.name} width={20} height={20} />
          </Box>
